...
class DocumentChunk(Base, TimestampMixin):
    ...
    # Lexical half of hybrid retrieval. Generated by the database so it cannot
    # drift from the text it indexes, and there is no application path that could
    # forget to update it. The header is weighted above the body so a query
    # naming a clause ranks that clause first.
    text_search = Column(
        TSVECTOR,
        Computed(
